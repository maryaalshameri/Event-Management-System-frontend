      ...
      <div class="p-6">
        <form @submit.prevent="changePassword" class="space-y-6">
          ...
          <div>
            ...
            <p v-if="errors.password" class="text-red-500 text-xs mt-2 flex items-center">
          ...
          <div class="flex gap-3 pt-4">
            ...
            >
              <i v-if="saving" class="fas fa-spinner fa-spin ml-2"></i>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const changePassword = async () => {
      ...
      try {
        await api.put(`/admin/users/${props.user.id}/password`, {
